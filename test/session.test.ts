...
describe("POST /mcp - MCP server", () => {
  ...
  it("tools/list returns all tools", async () => {
    ...
    expect(data.result.tools).toHaveLength(22);
    ...
    expect(names).toContain("list_load_jobs");
    expect(names).toContain("create_load_job");
    expect(names).toContain("update_load_job");
    expect(names).toContain("delete_load_job");
    expect(names).toContain("set_load_job_enabled");
    expect(names).toContain("trigger_load_job");
    expect(names).toContain("list_transform_jobs");
    expect(names).toContain("create_transform_job");
    expect(names).toContain("update_transform_job");
    expect(names).toContain("delete_transform_job");
    expect(names).toContain("trigger_transform_job");
